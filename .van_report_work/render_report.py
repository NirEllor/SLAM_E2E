...
stages_data = [
    ...
    ("4a. Database definition (Observation)", "Observation data structure for track observations",
     "class Observation", "code/tracking_database.py", 22),
    ("4b. Database definition (TrackingDB)", "TrackingDB data structure for tracking",
     "class TrackingDB", "code/tracking_database.py", 30),
    ("5. Adding a frame to the database", "Feature track integration across frames",
     "update_tracks", "code/tracking_database.py", 83),
    ("6. Single Bundle creation", "Single-window pose and landmark optimization via GTSAM",
     "solve_bundle_window", "code/project/utils/bundle_adjustment.py", 235),
    ("7. Relative transformation + covariance", "Pose constraint extraction with uncertainty quantification",
     "compute_relative_pose_and_covariance", "code/project/utils/pose_graph.py", 150),
    ("8a. PoseGraph building (init)", "Factor graph construction and initialization",
     "build_and_initialize_pose_graph", "code/project/utils/pose_graph.py", 77),
    ("8b. PoseGraph building (optimize)", "Factor graph optimization",
     "optimize_pose_graph", "code/project/utils/pose_graph.py", 105),
    ("9a. Loop closure detection", "Candidate detection via Mahalanobis distance",
     "detect_loop_closure_candidates", "code/project/utils/loop_closure.py", 42),
    ("9b. Loop closure factor creation", "Relative pose estimation and graph integration",
